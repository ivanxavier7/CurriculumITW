...
<html lang="en">
    <head>
        ...
        <title>Agency - Ivan Xavier</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead" style="background-image: url(<?php echo $main->bc_img ?>)">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{url($main->resume)}}">Read More</a>
            </div>
        </header>
        <!-- Services-->
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="portfolio-item">
                                    <a class="portfolio-link" data-toggle="modal" href="#portfolioModal<?php echo $portfolio->id?>">
                                        ...
                                        <img class="img-fluid" src="{{url($portfolio->small_image)}}" alt="Small Portfolio Image" />
                                    </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="assets/img/logos/estga.png" alt="" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="assets/img/logos/itaveiro.png" alt="" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="assets/img/logos/xavisub.png" alt="" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="assets/img/logos/xavisub.png" alt="" /></a>
                    </div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Please contact me if you have any question!</h3>
                </div>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright © Ivan Xavier 2020</div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="{{url($portfolio->big_image)}}" alt="Big Portfolio Image" />
